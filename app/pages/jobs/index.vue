      ...
      <div class="flex flex-col gap-6">
        ...
        >
          <div>
            ...
            <p class="mt-1 text-sm text-muted">
              The list, filters, and stats will be connected after the data
              layer is ready.
            </p>
          </div>
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div class="rounded-lg border border-default bg-elevated p-4">
            ...
            <p class="mt-2 text-2xl font-semibold text-highlighted">0</p>
          </div>
          <div class="rounded-lg border border-default bg-elevated p-4">
        ...
        >
          ...
          <h2 class="mt-4 text-base font-semibold text-highlighted">
            Data layer comes next
          </h2>
          <p class="mx-auto mt-2 max-w-md text-sm text-muted">
            Step 3 will add Prisma and SQLite. This page is the prepared UI
            shell for the main tracker view.
          </p>
        </div>
      </div>
    </UContainer>
